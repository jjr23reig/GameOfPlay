...
- `Usuarios sin registrar`: Aquellas personas que podran mirar la tienda junto a sus productos, pero no podran ni comprar ni participar en las actividades de la comunidad
...
- `Administrador`: El rol de administrador sera el de aquella persona que se encargara de actualizar las noticias de la aplicación, asi como gestionar los planes de pago de los usuarios
